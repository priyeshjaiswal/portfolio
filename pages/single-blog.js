      ...
      <div className="single-blog">
        <div className="container">
          <div className="blog-feature-img">
            <Image src="/static/img/single-blog.jpg" alt="Blog feature" width={800} height={400} />
          </div>
                ...
                <div className="article-title">
                  ...
                  <div className="media">
                    <div className="avatar">
                      <Image src="/static/img/team-1.jpg" alt="Author" width={60} height={60} />
                    </div>
                    <div className="media-body">
                      <label>Priyesh Jaiswal</label>
